                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="produk/<?php echo $row['product_image'] ?>" target="_blank"><img src="produk/<?php echo $row['product_image'] ?>" width="60px" height="60px" style="border-radius:50%;"></a></td>
